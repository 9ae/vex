...
function makeHistogram(data, col) {
  ...
  const x = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* scaleBand */]()
    .range([0, WIDTH])
    .paddingInner(INNER_PADDING)
    .paddingOuter(VMARGINS)
    .domain(fildata.map(d => d.name))
  const y = __WEBPACK_IMPORTED_MODULE_0_d3__["j" /* scaleLinear */]()
    .range([0, HEIGHT])
    .domain([0, __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* max */](fildata, d => d.value)])

    const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["l" /* select */]("svg")
    svg.attr('width', WIDTH)
    svg.attr('height', HEIGHT + HMARGINS)

  const histogram = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* histogram */]()
    .domain(x.domain())
...
function makeBubbles(data) {
  ...
  const quantize = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* scaleBand */]()
    .range([0, 1])
    .domain(byVariety.map(d => d.name))

  const color = wineType => __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* interpolateRainbow */](quantize(wineType))
  const radius = __WEBPACK_IMPORTED_MODULE_0_d3__["k" /* scaleLog */]()
    .range([MIN_RADIUS, MAX_RADIUS])
    .domain([__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* min */](byVariety, d => d.value), __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* max */](byVariety, d => d.value)])

  const force = __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* forceSimulation */](byVariety)
    .force('collide', __WEBPACK_IMPORTED_MODULE_0_d3__["c" /* forceCollide */](MAX_RADIUS))

  const px = __WEBPACK_IMPORTED_MODULE_0_d3__["j" /* scaleLinear */]()
    .range([MAX_RADIUS, WIDTH - MAX_RADIUS])
    .domain([__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* min */](byVariety, d => d.x), __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* max */](byVariety, d => d.x)])

  const py = __WEBPACK_IMPORTED_MODULE_0_d3__["j" /* scaleLinear */]()
    .range([MAX_RADIUS, HEIGHT - MAX_RADIUS])
    .domain([__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* min */](byVariety, d => d.y), __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* max */](byVariety, d=> d.y)])
  ...
  node.append('circle')
    ...
    .on('mouseover', function () {
      __WEBPACK_IMPORTED_MODULE_0_d3__["l" /* select */](this.parentNode).classed('focus', true)
    })
    .on('mouseout', function () {
      __WEBPACK_IMPORTED_MODULE_0_d3__["l" /* select */](this.parentNode).classed('focus', false)
    })
...
__WEBPACK_IMPORTED_MODULE_0_d3__["b" /* csv */]('data/wine.csv', (error, data) => {
  makeBubbles(data)
})
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__src_band__["a"]; });
